# ============================================================
# REWRITE tv_bos_v6.py WITH LIST-INDEXED CANDLE ACCESS
# ============================================================
bos_code = '''"""
...
with open('strategies/tv_bos_v6.py', 'w') as f:
    f.write(bos_code)
print("✅ Rewrote strategies/tv_bos_v6.py with list-indexed candle access")

# ============================================================
# REWRITE tv_smc_fvg.py WITH LIST-INDEXED CANDLE ACCESS
# ============================================================
smc_code = '''"""
...
with open('strategies/tv_smc_fvg.py', 'w') as f:
    f.write(smc_code)
print("✅ Rewrote strategies/tv_smc_fvg.py with list-indexed candle access")

print("\n🎉 Both strategies fixed. Candle format: [ts, open, high, low, close, vol]")
